...
";
    ...
    ";
            ...
            ";
                // line 26
                if ((twig_in_filter(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 26), twig_get_array_keys_filter(twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "favorites", [], "any", false, false, true, 26))) == false)) {
                    // line 27
                    echo "                <button onclick=\"addToFavorites(";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 27), 27, $this->source), "html", null, true);
                    echo ", '";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "favorites", [], "any", false, false, true, 27), "endpoint", [], "any", false, false, true, 27), 27, $this->source), "html", null, true);
                    echo "')\">Añadir a favoritos</button>
            ";
                } else {
                    // line 29
                    echo "                <button onclick=\"removeFromFavorites(";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 29), 29, $this->source), "html", null, true);
                    echo ", '";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "favorites", [], "any", false, false, true, 29), "endpoint", [], "any", false, false, true, 29), 29, $this->source), "html", null, true);
                    echo "')\">Borrar de favoritos</button>
            ";
                }
                // line 31
...
";
    ...
    {
        return array (  154 => 35,  151 => 34,  147 => 32,  140 => 31,  132 => 29,  124 => 27,  122 => 26,  118 => 25,  114 => 24,  110 => 23,  104 => 22,  101 => 21,  96 => 20,  88 => 17,  80 => 15,  72 => 13,  70 => 12,  66 => 11,  62 => 10,  56 => 9,  53 => 8,  48 => 7,  46 => 6,  39 => 1,);
    }
...
{% if data.category == 'characters' %}
    {% for item in data.response.data.results %}
        <div>
            ...
            {% if item.id in data.favorites|keys == false %}
                <button onclick=\"addToFavorites({{ item.id }}, '{{ data.favorites.endpoint }}')\">Añadir a favoritos</button>
            {% else %}
