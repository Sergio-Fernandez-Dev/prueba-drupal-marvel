...
class __TwigTemplate_8dc4445a0c5291b4c4cb084ac7e078b9 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<div class=\"permission\"><span class=\"title\">{{ title }}</span>{% if description or warning %}<div class=\"description\">{% if warning %}<em class=\"permission-warning\">{{ warning }}</em> {% endif %}{{ description }}</div>{% endif %}</div>", "__string_template__f708b51172140bd84a89cacc0ed43a92", "");
    }
